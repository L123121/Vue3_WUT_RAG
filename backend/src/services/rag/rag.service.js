...
const { DocumentService } = require('../knowledge/document.service');
const { WikiService } = require('../wiki/wiki.service');
const { EmbeddingService } = require('../knowledge/embedding.service');
const { vectorStore: vectorStoreSingleton } = require('../knowledge/vector-store-qdrant.service');
const { RerankerService } = require('../knowledge/reranker.service');
...
const { tryWikiPipeline, mergeWikiAndRagPipelines } = require('./rag-wiki-pipeline.service');
const { drainChat } = require('./rag-chat-drain.service');
